...
module.exports = {
  up: async (pool) => {
    ...
    console.log('✓ Migration 20260401000000_create_llm_request_records completed');
  },
  
  down: async (pool) => {
    await pool.query('DROP TABLE IF EXISTS llm_request_records CASCADE');
    console.log('✓ Rollback 20260401000000_create_llm_request_records completed');
  }
};
